window.onload = function () {
    ...
    new Chart(document.getElementById("Chart-4"), {
        ...
        data: {
            ...
            datasets: [
                { fill: true, tension: 0, backgroundColor: "rgba(255, 97, 70, 0.7)", data: [2, 4, 5, 7, 8, 7] },
                { fill: true, tension: 0, backgroundColor: "rgba(255, 187, 91, 0.7)", data: [5, 5, 7, 8, 10, 8] },
                { fill: true, tension: 0, backgroundColor: "rgba(211, 255, 91, 0.7)", data: [7, 8, 10, 12, 11, 9] },
                { fill: true, tension: 0, backgroundColor: "rgba(91, 255, 142, 0.7)", data: [10, 9, 12, 15, 15, 14] },
                { fill: true, tension: 0, backgroundColor: "rgba(57, 222, 255, 0.7)", data: [15, 14, 18, 18, 18, 17] }
            ]
        },
        options: {
            plugins: { legend: { display: false } },
